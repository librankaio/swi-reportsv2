...
@section('content')
  ...
  <form action="/mutasibhnbaku" method="get" class="container-fluid px-5 py-2" id="myform">
    <div class="head-form">
      <div class="row">                
        <div class="container col-md-4 bg-white px-4 pt-3" style="border-top-left-radius: 10px;">
          <div class="row">              
        ...
        <div class="container col-md-4 bg-white px-4 pt-3" style="border-top-right-radius: 10px;"></div>     
              ...
              <div class="mb-3">   
                ...
                <select class="form-select" aria-label="Default select example" name="lokasi">
                  ...
                  ?>
                    ...
                    <option value="GUDANG HO">Gudang HO</option>
                  <?php }else{ ?>
                    <option selected value='{{ $_GET['lokasi'] }}'>{{ $_GET['lokasi'] }}</option>
                    <option value='HAMPARAN #1'>Hamparan #1</option>
                    <option value="GUDANG HO">Gudang HO</option>
                  <?php } ?>
                </select>
